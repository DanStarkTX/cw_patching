...
```powershell
irm "https://raw.githubusercontent.com/DanStarkTX/cw_patching/main/bootstrap.ps1" | iex
```

**Dev Branch**

```powershell
irm "https://raw.githubusercontent.com/DanStarkTX/cw_patching/dev/bootstrap.ps1" | iex
```
